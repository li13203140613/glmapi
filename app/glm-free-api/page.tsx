...
export const metadata: Metadata = {
  title: "GLM Free API - How to Get Free GLM 4.7 API Access in 2025 | GLM API Proxy",
  description: "Complete guide to GLM free API access. Learn which GLM models are free, how to get GLM API free access, and affordable alternatives with GLM-4-Flash and our 40% discount.",
  keywords: "glm 4.7 free api, glm free api, glm api free, free glm api, glm-4-flash free, zhipu ai free api",
  alternates: {
    canonical: "https://glm-api.org/glm-free-api",
  },
  openGraph: {
    title: "GLM Free API - Get Free Access to GLM 4.7 API",
    description: "Learn how to get free GLM API access with GLM-4-Flash and other free models. Plus 40% off alternative for unlimited usage.",
    url: "https://glm-api.org/glm-free-api",
    type: "article",
  },
};

export default function GLMFreeAPIPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "GLM Free API - How to Get Free GLM 4.7 API Access",
    "description": "Comprehensive guide to accessing free GLM API models including GLM-4-Flash and understanding free tier limitations",
    "author": {
      "@type": "Organization",
      "name": "GLM API Proxy"
    },
        ...
        <nav className="bg-gray-50 border-b border-gray-200 px-6 py-3">
          <div className="mx-auto max-w-4xl">
            <ol className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <li>/</li>
              <li className="text-gray-900 font-medium">GLM Free API</li>
            </ol>
          </div>
        </nav>
        ...
        <section className="px-6 py-16 bg-gradient-to-br from-emerald-50 via-white to-emerald-50">
          <div className="mx-auto max-w-4xl">
            <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">
              GLM Free API - Get Free Access to GLM 4.7 API
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed">
              Discover how to access GLM API for free, which models are available at no cost, and the best affordable alternatives for production applications.
            </p>
          </div>
        </section>
        ...
        <section className="px-6 py-16 bg-gradient-to-br from-emerald-600 to-emerald-800">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-3xl font-bold text-white mb-4">
              Ready to Upgrade from Free Tier?
            </h2>
            <p className="text-lg text-emerald-100 mb-8">
              Get unlimited access to all GLM models at 40% off official pricing. Leave your email and we'll set up your account within 72 hours.
            </p>
