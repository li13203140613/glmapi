...
export const metadata: Metadata = {
  title: "GLM API Key - How to Get and Use Your GLM API Key | Complete Setup Guide",
  description: "Step-by-step guide to getting and using your GLM API key. Learn how to obtain, configure, and secure your GLM 4.7 API key for development. Includes troubleshooting tips.",
  keywords: "glm 4.7 api key, glm api key, zhipu ai api key, glm-4 api key, how to get glm api key",
  alternates: {
    canonical: "https://glm-api.org/glm-api-key",
  },
  openGraph: {
    title: "GLM API Key - Complete Setup Guide",
    description: "Learn how to get, configure, and use your GLM API key securely. Includes best practices and troubleshooting tips.",
    url: "https://glm-api.org/glm-api-key",
    type: "article",
  },
};

export default function GLMAPIKeyPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "GLM API Key - How to Get and Use Your GLM API Key",
    "description": "Comprehensive guide to obtaining, configuring, and securing your GLM API key for development",
    "author": {
      "@type": "Organization",
      "name": "GLM API Proxy"
    },
        ...
        <nav className="bg-gray-50 border-b border-gray-200 px-6 py-3">
          <div className="mx-auto max-w-4xl">
            <ol className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <li>/</li>
              <li className="text-gray-900 font-medium">GLM API Key</li>
            </ol>
          </div>
        </nav>
